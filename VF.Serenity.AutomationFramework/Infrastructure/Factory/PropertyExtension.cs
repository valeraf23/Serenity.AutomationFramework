...
namespace VF.Serenity.AutomationFramework.Infrastructure.Factory
{
    internal static class PropertyExtension
    {
        ...
        internal static bool HasTitleAttribute(this Type pageType)
        {
            var attributes = pageType.CustomAttributes;
            return attributes.Any(attribute => attribute.AttributeType == typeof(TitleAttribute));
        }

        internal static TitleAttribute GetTitleAttribute(this Type pageType)
        {
            var urlAttribute = (TitleAttribute) Attribute.GetCustomAttribute(pageType, typeof(TitleAttribute));
            return urlAttribute;
        }
